...
class TestOptions(BaseOptions):
	def initialize(self):
		...
		#self.parser.add_argument("--dataroot", type=str, default='dataset/visDrone/val')

		#self.parser.add_argument("--dataset_mode", default="FineVal")
		self.parser.add_argument("--dataset_mode", default="FineVal")
		#self.parser.add_argument("--dataset_mode", default="CenterVal")


		self.parser.add_argument("--name", type=str, default='uavdtaugfine')
		#self.parser.add_argument("--name", type=str, default='stack_aug')
		#self.parser.add_argument("--name", type=str, default='stack')
