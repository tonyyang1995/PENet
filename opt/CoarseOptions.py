...
class TrainOptions(BaseOptions):
	def initialize(self):
		...
		#self.parser.add_argument("--dataroot", type=str, default='dataset/visDrone/train')
		self.parser.add_argument("--dataroot", type=str, default='dataset/UAVDT/train')

		self.parser.add_argument("--dataset_mode", default="Coarse", help="coarse, fine, coarseval, fineval, crop")
		...
		# load model
		self.parser.add_argument("--load_model", default='checkpoints/uavdt_coarse/hourglass_0.pth')
		...
		#svimelf.parser.add_argument('--shm_weight', type=float, default=1, help='loss weight for keypoint heatmap')
